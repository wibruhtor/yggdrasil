...
impl BanWordService {
    ...
    pub async fn get_filter(
        ...
        let span = tracing::debug_span!("get ban word filter by filter id");
        let _span = span.enter();
    ...
    pub async fn delete_filter(&self, user_id: &str, ban_word_filter_id: &Uuid) -> AppResult {
        let span = tracing::debug_span!("delete ban word filter by filter id");
        let _span = span.enter();
    ...
    pub async fn get_ban_words(
        ...
        let span = tracing::debug_span!("get ban words in filter");
        let _span = span.enter();
    ...
    pub async fn update_ban_words(
        ...
        let span = tracing::debug_span!("update ban words in filter");
        let _span = span.enter();
